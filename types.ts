...
export interface ParticipationFormProps {
  ...
  participations: Participation[]; // NOVO: Necessário para validação de duplicidade e conflitos
  rules: Rule[];
...
// NOVO: Tabela de Backup para persistência robusta de histórico
export interface HistoryBackupItem {
    id: string; // UUID
    week: string;
    participations: Participation[]; // Snapshot completo das participações daquela semana importada
